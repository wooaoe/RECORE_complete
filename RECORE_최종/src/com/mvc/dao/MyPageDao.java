...
public interface MyPageDao {
   ...
   public Vo_QnA My_selectBoardProdOne(int qna_no); //상품문의 board 하나 select
   
   public Vo_QnA My_selectBoardOne(int qna_no); //상품문의 외 board 하나 select
   ...
   public Vo_Product selectProd(int prod_no); //qna에서 상품정보 가져오기
