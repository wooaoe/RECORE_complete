...
public class MyPageDaoImp implements MyPageDao{
      ...
      try {
         ...
         while(rs.next()) {
           vo_fun = new Vo_Funding(rs.getInt(1),rs.getString(2),
            ...
            vo_fun_d  = new Vo_Funding_Payment(rs.getInt(12),rs.getInt(1),
   ...
   @Override
   public Vo_QnA My_selectBoardProdOne(int qna_no) {
      Connection con = getConnection();
      PreparedStatement pstmt = null;
      ResultSet rs = null;
      Vo_QnA vo_qna = null;
      String sql = "SELECT * FROM QNA JOIN PROD_OPTION ON(QNA_SEQ_NO=PROD_NO) JOIN PRODUCT USING(PROD_NO) WHERE QNA_NO=?";
   ...
   public boolean managerUpdate(int order_no, int prod_id, String tno) {
	...
	@Override
	public Vo_Product selectProd(int prod_no) {
		Connection con = getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Vo_Product vo_prod = null;
		...
		try {
			...
			while(rs.next()) {
				vo_prod = new Vo_Product(rs.getInt(1),rs.getInt(2),
										rs.getString(3),rs.getString(4),
										rs.getString(5),rs.getString(6),
										rs.getInt(7),rs.getString(8),
										rs.getInt(9),rs.getString(10),
										rs.getDouble(11),rs.getDate(12),
										rs.getString(13));
			}
