...
public class Vo_Funding {
	...
	public Vo_Funding(int fund_no, String fund_front_img, String fund_title, String fund_creator, String fund_content,
	...
	public Vo_Funding(int fund_no,  String fund_front_img, String fund_title, String fund_creator,
			...
			String fund_sof, int fund_total) {
		super();
		this.fund_no = fund_no;
	...
	public void setFund_total(int fund_total) {
		this.fund_total = fund_total;
	}
	...
	public String toString() {
		return "Vo_Funding [fund_no=" + fund_no  + ", fund_front_img="
				...
				+ ", fund_regdate=" + fund_regdate + ", fund_deadline=" + fund_deadline + ", fund_sof=" + fund_sof +", fund_total="+fund_total
				+ "]";
	}
