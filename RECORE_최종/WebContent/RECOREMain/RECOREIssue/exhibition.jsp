      ...
      <div class="container">
         <div class="row">
          <div class="col-12 text-center">
           <span class="sub-title">전시 / 기획전</span>
            <h2 class="font-weight-bold text-black mb-5">Exhibition</h2>
...
%>         
        ...
        <div class="row" style="text-align: center;">
           ...
           <div class="" style="width:100%; margin-top:20px; text-align :center; padding-left: 44%;">
            ...
            %>
              <c:choose>
                 <c:when test="${issue_list.size() <= 6 }">
                    <div class="newsButtonWhite">1</div>
                 </c:when>
                 <c:when test="${issue_list.size() > 6 }">
                    <c:forEach begin="1" end="<%=((listsize-1)/6)+1 %>" var="i">
                       <c:if test="${i == page }">
