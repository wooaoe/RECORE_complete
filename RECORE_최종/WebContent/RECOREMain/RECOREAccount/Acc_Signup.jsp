   ...
   <div id="wrap">
      ...
      <div id="container">
         <div id="content">
            ...
            <div class="titleArea" style="margin-top: 10px;">
               <h2 style="text-align: left; font-size: 25px;">회원 가입</h2><br><br>
            </div>
            ...
            <form id="form" name="form" action="../../Account_Controller.do?command=Acc_insert" method="post" target="_self" >
               ...
               <div class="xans-element- xans-member xans-member-join">
                  <h3 class=" " style="text-align: left; font-size: 16px; margin: 30px 0px 0px 0px;">기본정보</h3>
                  <p class="required ">
                     <img
                  ...
                  <div class="ec-base-button">
                     <input type="submit" id="join" name="join" value="회원가입" style="background-color:#A0D9D9; cursor: pointer;" class="btnSubmitFix sizeM">
