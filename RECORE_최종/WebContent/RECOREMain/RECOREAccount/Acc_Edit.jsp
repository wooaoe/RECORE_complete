...
/* 	$("input[name='is_solar_calendar']").attr('disabled',true); 양력 음력 버튼 비활성화 */
						...
						<div class="ec-base-table typeWrite">
							<table border="1" summary="">
								...
								<tbody>
									...
									<%	 String phone = vo.getAcc_phone();
										 String phoneNumber1 = phone.split("-")[0];
										 String phoneNumber2 = phone.split("-")[1];
										 String phoneNumber3 = phone.split("-")[2];
									%>
									<tr class="">
										...
										-<input id="mobile2" name="mobile2"
											value="<%=phoneNumber2 %>" type="text" style="width: 40px;" maxlength="4" required />
										-<input id="mobile3" name="mobile3"
											value="<%=phoneNumber3 %>" type="text" style="width: 40px;" maxlength="4"	required />
