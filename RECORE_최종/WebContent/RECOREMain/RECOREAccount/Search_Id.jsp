...
<script type="text/javascript">
	$(document).ready(function() {
		$("input:radio[name=check_method]").click(function() {

			if ($("input[name=check_method]:checked").val() == "2") {
				$("#email_view").css("display", "none");
				$("#mobile_view").css("display", "");
			} else if ($("input[name=check_method]:checked").val() == "1") {
		...
		$("input[name=search]").click(function() {
			...
			if ($("input[name=check_method]:checked").val() == "1") {
				$.ajax({
					url : "../../Account_Controller.do?command=idemail",
					...
					success : function(data) {
						if (data.res != null) {
							alert(name + " 회원님의 아이디는 " + data.res + "입니다.")
						} else {
			...
			} else if ($("input[name=check_method]:checked").val() == "2") {
				$.ajax({
					url : "../../Account_Controller.do?command=idphone",
     ...
     -->
						<div class="findId">
							...
							<fieldset>
								...
								<p class="check" style="position:relative; left:45px">
									<input id="check_method1" name="check_method" value="1" type="radio"
										checked="checked" /> <label for="check_method1">이메일로 찾기</label> <input
										id="check_method2" name="check_method" value="2" type="radio" /> <label
										for="check_method2"> <span
										id="search_type_mobile_lable" style="display: inline;">휴대폰번호로 찾기</span>
									</label>
								</p>
								<p id="name_view" class="name" style="position:relative; left:60px">
									<strong id="name_lable">이름</strong> <input id="name"
										name="name" class="lostInput" placeholder="" value="" type="text" />
								</p>
								<p id="email_view" class="email" style="position:relative; left:60px">
									<strong>이메일</strong> <input id="email" name="email" class="lostInput"
										placeholder="" value="" type="text" />
								</p>
								<p id="mobile_view" class="mobile" style="display: none; position:relative; left:60px">
									<strong>휴대폰 번호</strong> 
									<br> 
									<input id="mobile1" name="mobile1" class="mobile1" placeholder=""
										maxlength="3" value="" type="text" />
									- <input id="mobile2" name="mobile2" class="mobile2" placeholder=""
										maxlength="4" value="" type="text" />
									- <input id="mobile3" name="mobile3" class="mobile2" placeholder=""
										maxlength="4" value="" type="text" />
								</p>
