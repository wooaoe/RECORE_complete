...
<script type="text/javascript">
   ...
   function pageMove(pageNo,catd,keyword){ //페이징
      var catd = $("#catd").val();
      var keyword = $("#keyword").val();
      
      location.href = "mypage.do?command=searchboard&catd="+catd+"&keyword="+keyword+"&pageno="+pageNo;
   }
       ...
       <div id="container">
           <div id="content" style="margin-top: 100px;">
            ...
            <div class="xans-element- xans-myshop xans-myshop-boardpackage ">
               ...
               <input type="hidden" id="catd" name="catd" value="${catd}">
                  ...
                  <fieldset class="boardSearch">
                     <legend>게시물 검색</legend>
                          <p>
                           ...
                           <input id="searchval" name="search" fw-filter="" fw-label="" fw-msg="" class="inputTypeText" value="${keyword}" placeholder="" type="text"> 
