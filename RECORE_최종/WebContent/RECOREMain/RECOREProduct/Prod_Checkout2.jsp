...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			/* 카카오페이 결제 클릭 시 주의사항 부분 띄워주기 **20/01/15 승혜 */			
	 ...
	 function payment(){ //결제하기 누르면 발생하는 이벤트 
		...
		if($("input:checkbox[id='agreeV2']").is(":checked") == false){
			...
			if($("#allDepositCheckboxV2").is(":checked") == false && $("#allDepositCheckboxV1").is(":checked") == false){ 
				...
				"&totalPrice=" + <%=price%> + "&prod_id=" + <%=prod_id%> + "&acc_addrs=" + accinfo +
				"&acc_point=" + zeropoint; 
